        ...
        <div class="container">
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#restaurantes" tabindex="-1" aria-disabled="true">Restaurants</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#hospedajes" tabindex="-1" aria-disabled="true">Hospedajes</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Tours</a></li>
